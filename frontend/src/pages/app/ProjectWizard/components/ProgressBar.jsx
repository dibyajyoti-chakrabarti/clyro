...
export default function ProgressBar({ currentStep, stepConfig, completedSteps, statusMap }) {
  ...
  return (
    <aside className='hidden w-[312px] shrink-0 flex-col bg-[rgba(10,15,25,0.55)] px-7 py-8 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_0_0_1px_rgba(255,255,255,0.08),0_20px_60px_rgba(0,0,0,0.22),0_0_36px_rgba(76,115,255,0.08)] backdrop-blur-[20px] lg:flex xl:w-[320px]'>
      <style>{`
      ...
      <div className='flex flex-col rounded-[24px] border border-white/[0.08] bg-[rgba(10,15,25,0.55)] px-[28px] py-[32px] shadow-[inset_0_1px_0_rgba(255,255,255,0.03),0_0_0_1px_rgba(255,255,255,0.06),0_0_34px_rgba(232,184,75,0.05)] backdrop-blur-[20px]'>
        <div>
          <p className='mb-8 text-[12px] font-semibold uppercase tracking-[0.18em] text-[#E8B84B]'>
            Step {currentStep} of {totalSteps}
          </p>

          <ol className='relative space-y-[42px]'>
              ...
              return (
                ...
                >
                  <div className='relative w-[48px] shrink-0 sm:w-[44px] lg:w-[48px]'>
                    {!isLast ? (
                      <span
                        className='pointer-events-none absolute left-[24px] top-[48px] h-[42px] w-[2px] -translate-x-1/2 bg-[rgba(255,255,255,0.12)] transition-colors duration-[300ms]'
        ...
        <p className='mt-auto flex items-center gap-1.5 pt-8 text-xs text-white/70'>
