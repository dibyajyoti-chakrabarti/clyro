export default function CanvasSurface({
  ...
  return (
    <>
      <div
        ref={surfaceRef}
        className="relative flex-[1.9] min-w-0 cursor-grab select-none overflow-auto rounded-[24px] active:cursor-grabbing transition-[opacity,transform,border-color,box-shadow] duration-[420ms] ease-[cubic-bezier(.22,1,.36,1)]"
        style={{
